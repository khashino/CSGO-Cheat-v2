            ...
            while True:
                ...
                try:
                    ...
                    for i in range(1, 32):
                        ...
                        key = self.get_key()
                        #print(key)
                        #print(win32api.GetKeyState(0x12))
                        ...
                        if entity:
                            ...
                            if localTeam != entity_team_id and entity_hp > 0:
                                ...
                                localpos_y_angles = self.pm.read_float(
                                    self.engine_pointer + dwClientState_ViewAngles + 0x4)
                                ...
                                try:
                                    ...
                                    continue
                                try:
                                    X, Y = self.calcangle(localpos1, localpos2, localpos3, entitypos_x, entitypos_y,
                                                          entitypos_z)
                                except:
                                    pass
                            ...
                            if key and player:
                                if target and target_hp > 0 and not target_dormant:
                                    ...
                                    if key:
                                        ...
                                        Desired = self.pm.read_int(
                                            self.engine_pointer + clientstate_last_outgoing_command) + 2
